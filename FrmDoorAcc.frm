...
Begin VB.Form FrmDoorAcc 
   ...
   Begin VB.ComboBox CmbCategory 
      Height          =   315
      ItemData        =   "FrmDoorAcc.frx":0000
      Left            =   1350
      List            =   "FrmDoorAcc.frx":0002
      TabIndex        =   1
      Top             =   480
      Visible         =   0   'False
      Width           =   1695
...
Dim j As Integer
    rsTemp.Open "photo_category1", cn, adOpenForwardOnly, adLockReadOnly
    j = 0
